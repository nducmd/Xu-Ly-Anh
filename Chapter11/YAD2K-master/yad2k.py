    ...
    for section in cfg_parser.sections():
        ...
        if section.startswith('convolutional'):
            ...
            if batch_normalize:
                ...
                # Darknet BatchNormalization weights are stored as:
            ...
            conv_layer = Conv2D(
                ...
                activation=None,  # No activation function here, we will apply it later
                padding=padding
            )(prev_layer)

            # Apply BatchNormalization if required
            if batch_normalize:
                gamma_initializer = Constant(value=bn_weight_list[0])  # Custom weight for gamma
                beta_initializer = Constant(value=bn_weight_list[1])  # Custom weight for beta
